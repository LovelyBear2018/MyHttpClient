 ...
 */
public class SeleniumMapperMethod extends MapperMethod {
     ...
     * @param config
     */
    public SeleniumMapperMethod(String sessionID, Class<?> mapperInterface, Method method, Configuration config) {
