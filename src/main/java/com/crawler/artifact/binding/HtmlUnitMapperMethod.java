 ...
 */
public class HtmlUnitMapperMethod extends MapperMethod{
    /**
     * 基本信息初始化
     * @param sessionID
     ...
     * @param config
     */
    public HtmlUnitMapperMethod(String sessionID, Class<?> mapperInterface, Method method, Configuration config) {
